@web @web-engine-parity
Feature: Web Engine Parity and Capability Verification
  ...
  @web @parity-cookies @playwright-java @playwright-ts
  Scenario: Verify cookie management across Playwright engines
  ...
  @web @parity-viewport @playwright-java @playwright-ts
  Scenario: Verify viewport resizing across web engines
    Given I start the web session for parity testing
  ...
  @web @parity-async @playwright-java @playwright-ts
  Scenario: Verify async script execution with timeout protection
    Given I start the web session for parity testing
